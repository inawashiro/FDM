...
namespace FDM
{
    public static class BSBarrierAnalytic
    {
        ...
        private static void SetBoundaryCondition(int tNum, int xNum, double[,] pVArray, double boundaryPV, double strike, bool isCall) { }
        private static void SetInitialCondition(int xNum, double[,] pVArray, double boundaryPV, double strike, bool isCall)
        {
